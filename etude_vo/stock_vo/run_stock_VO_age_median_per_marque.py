...
from save_last_year_age_median_per_marque import save_last_year_age_median_per_marque
...
FINAL_OUTPUT_FILE_PATH = (
    PROJECT_DATA_FOLDER_PATH + "final_outputs/france-last-year-age-median-par-marque.xlsx"
)

save_last_year_age_median_per_marque(CONCATENATED_FILE_PATH, FINAL_OUTPUT_FILE_PATH)
